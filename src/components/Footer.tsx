        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <a href="mailto:dohyon18@nave.com" className="text-white hover:underline">
                dohyon18@nave.com
              </a>
            </div>
            <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3 mt-4">
              ...
              <a href="https://instagram.com/username" className="text-white hover:underline" target="_blank" rel="noreferrer">
                @dohyon
              </a>
            </div>
            <div className="flex items-center space-x-3">
